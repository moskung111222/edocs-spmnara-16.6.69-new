...
class AuthMiddleware {
    ...
    public static function requireOfficer(array $allowedRoles = []) {
        ...
        if (!isset($_SESSION['officer_id'])) {
            header("Location: " . Config::SITE_URL . "/admin/login.php");
            exit;
        }
            ...
            if (!in_array($currentRole, $allowedRoles)) {
                ...
                die("
                    <div style='font-family: sans-serif; text-align: center; margin-top: 100px;'>
                        ...
                        <p><a href='" . Config::SITE_URL . "/admin/dashboard.php' style='color: #1e3a8a; font-weight: bold;'>กลับไปยังหน้าหลัก</a></p>
                    </div>
                ");
            }
        }
    ...
    public static function requireTrackingAuth($requestNo) {
        ...
        if (!isset($_SESSION['tracking_auth'][$requestNo]) || $_SESSION['tracking_auth'][$requestNo] !== true) {
            header("Location: " . Config::SITE_URL . "/request/track.php?no=" . urlencode($requestNo) . "&unauthorized=1");
            exit;
        }
    }
